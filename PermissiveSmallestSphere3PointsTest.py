...
# RotMatrix = [[math.cos(alpha)*math.cos(beta), (math.cos(alpha)*math.sin(beta)*math.sin(gamma)) - (math.sin(
# alpha)*math.cos(gamma)), (math.cos(alpha)*math.sin(beta)*math.cos(gamma)) + (math.sin(alpha)*math.sin(gamma))],
# [math.sin(alpha)*math.cos(beta), (math.sin(alpha)*math.sin(beta)*math.sin(gamma)) - (math.cos(alpha)*math.cos(
# gamma)), (math.sin(alpha)*math.sin(beta)*math.cos(gamma)) - (math.cos(alpha)*math.sin(gamma))], [-math.sin(beta),
# math.cos(beta)*math.sin(gamma), math.cos(beta)*math.cos(gamma)]] rot_matrix_transpose = np.transpose(RotMatrix)
# print("Determinant: " + format(np.linalg.det(RotMatrix))) print("Mult'd by transpose: " + format(np.matmul(
# RotMatrix, rot_matrix_transpose)))
