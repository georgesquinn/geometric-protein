...
sphere_produced = FindSmallestSphere4Points.main(points_array)
three_sphere_produced = FindSmallestSphere3Points.main(points_array)
print("Three Point Sphere Radius is: " + format(three_sphere_produced[0]))
print("Inner radius is: " + format(radius))
print("Total radius is: " + format(radius + extra_radius))
print("Actual center is at (" + format(x_center) + ", " + format(y_center) + ", " + format(z_center) + ")")
