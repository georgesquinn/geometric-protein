...
# phi_one = math.pi
x_one = ((radius) * math.sin(theta_one) * math.cos(phi_one)) + x_center
y_one = ((radius) * math.sin(theta_one) * math.sin(phi_one)) + y_center
z_one = ((radius) * math.cos(theta_one)) + z_center
...
sphere_produced = PermissiveFindSmallestSphere2Points.main(points_array, .1)
print("Total radius is: " + format(radius))
print("Extraneous radius is: " + format(radius + extra_radius))
